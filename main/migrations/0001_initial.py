# Generated by Django 4.2.1 on 2023-09-21 17:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('slug', models.SlugField(max_length=255, unique=True, verbose_name='URL')),
                ('content', froala_editor.fields.FroalaField(verbose_name='Содержимое страницы')),
                ...
                ('parent_page', models.CharField(choices=[], default='', max_length=255, verbose_name='Имя родительского пункта в меню')),
            ],
            options={
