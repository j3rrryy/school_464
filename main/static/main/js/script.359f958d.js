...
function applyTheme(theme) {
  allElements.forEach((e) => {
    ...
    switch (theme) {
      case "default":
        e.style.backgroundColor = e.getAttribute(
...
document
  ...
  .addEventListener("click", () => changeFont(2));
document
  .getElementById("normalFontBtn")
